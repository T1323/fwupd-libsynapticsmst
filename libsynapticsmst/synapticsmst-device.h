...
SynapticsMSTDevice	*synapticsmst_device_new	(SynapticsMSTDeviceKind kind, const gchar* aux_node);
...
gboolean synapticsmst_device_get_flash_checksum (SynapticsMSTDevice *device, int length, int offset, unsigned char *checksum, GError **error);
